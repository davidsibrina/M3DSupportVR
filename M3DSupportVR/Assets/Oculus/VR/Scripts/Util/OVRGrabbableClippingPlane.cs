...
/// </summary>
public class OVRGrabbableClippingPlane : MonoBehaviour
{
    [SerializeField]
    ...
    protected OVRGrabberClippingPlane m_grabbedBy = null;
	...
	/// </summary>
    public OVRGrabberClippingPlane grabbedBy
    {
	...
	/// </summary>
	virtual public void GrabBegin(OVRGrabberClippingPlane hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
