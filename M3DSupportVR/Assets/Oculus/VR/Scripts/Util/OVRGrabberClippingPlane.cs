...
public class OVRGrabberClippingPlane : MonoBehaviour
{
	...
	protected OVRGrabbableClippingPlane m_grabbedObj = null;
    protected Vector3 m_grabbedObjectPosOff;
    protected Quaternion m_grabbedObjectRotOff;
	protected Dictionary<OVRGrabbableClippingPlane, int> m_grabCandidates = new Dictionary<OVRGrabbableClippingPlane, int>();
	protected bool m_operatingWithoutOVRCameraRig = true;

    /// <summary>
    /// The currently grabbed object.
    /// </summary>
    public OVRGrabbableClippingPlane grabbedObject
    {
        get { return m_grabbedObj; }
    }

	public void ForceRelease(OVRGrabbableClippingPlane grabbable)
    {
        bool canRelease = (
            (m_grabbedObj != null) &&
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
		...
		OVRGrabbableClippingPlane grabbable = otherCollider.GetComponent<OVRGrabbableClippingPlane>() ?? otherCollider.GetComponentInParent<OVRGrabbableClippingPlane>();
    ...
    protected virtual void GrabBegin()
    {
		...
		OVRGrabbableClippingPlane closestGrabbable = null;
        Collider closestGrabbableCollider = null;

        // Iterate grab candidates and find the closest grabbable candidate
		foreach (OVRGrabbableClippingPlane grabbable in m_grabCandidates.Keys)
        {
	...
	protected virtual void OffhandGrabbed(OVRGrabbableClippingPlane grabbable)
    {
